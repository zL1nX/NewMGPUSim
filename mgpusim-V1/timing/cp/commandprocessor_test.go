...
var _ = Describe("CommandProcessor", func() {
	...
	var (
		...
		toPUFSender               *MockBufferedSender
	...
	BeforeEach(func() {
		...
		toPUFSender = NewMockBufferedSender(mockCtrl)
		...
		commandProcessor.toPUFSender = toPUFSender
