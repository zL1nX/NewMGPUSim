...
// WithEncryptedMemoryCopyMiddleware uses global storage with encryption for memory transfers
func (b Builder) WithEncryptedMemoryCopyMiddleware() Builder {
	b.useEncryptedMemoryCopy = true
	return b
}
...
func (b Builder) Build(name string) *Driver {
	...
	if b.useEncryptedMemoryCopy {
		encryptedMemoryCopyMiddleware := NewEncryptedGlobalStorageMemoryCopyMiddleware(driver)
		driver.middlewares = append(driver.middlewares, encryptedMemoryCopyMiddleware)
	} else if b.useMagicMemoryCopy {
