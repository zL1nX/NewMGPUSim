...
// WithEncryptedMemoryCopyMiddleware configures the platform to use encrypted memory transfers
func (b EmuBuilder) WithEncryptedMemoryCopyMiddleware() EmuBuilder {
...
func (b *EmuBuilder) buildGPUDriver(
	...
	if b.useEncryptedMemoryCopy {
		gpuDriverBuilder = gpuDriverBuilder.WithEncryptedMemoryCopyMiddleware()
