...
func (b *R9NanoGPUBuilder) populateExternalPorts() {
	...
	// b.gpu.Domain.AddPort("PUF", b.pufComponent.GetPortByName("ToCP"))
	// this sentence should be removed, because this would seize the right of this ToCP port, which leads to the original connection between CP and PUF being broken
